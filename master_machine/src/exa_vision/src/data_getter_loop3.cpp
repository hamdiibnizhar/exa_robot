...
std::string filenameData = "exa_robot__loop3_" + std::to_string(year) + "_" + std::to_string(month) + "_" + std::to_string(day) + "_" + std::to_string(hour) + "_" + std::to_string(minutes) + EXTENSION;
...
{
    ros::init(argc, argv, "saving_data_robot_loop3");
